...
import com.example.carpet.safesave.SafeSaveStore;
...
/**
 * {@code /safesave} — runtime control of the {@link DebugSwitches} channels plus safe-save status.
 *
 * <p>Only functional while {@link DebugSwitches#DEBUG} is {@code true}; in a release build
 * ({@code DEBUG = false}) the command is not registered at all.
 *
 * <pre>
 * /safesave                           show all channel states
 * /safesave &lt;channel&gt; &lt;true|false&gt;     toggle one channel
 * /safesave all &lt;true|false&gt;          toggle every channel
 * /safesave status                    safe-save status / statistics
 * </pre>
 */
@CommandRegister
